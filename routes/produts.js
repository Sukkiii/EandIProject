...
const { addCategory, updateCategory, deleteCategory, addProduct, getProduct, getProductList, getProductDetail, deleteProduct } = require('../services/productServices');
...
// 최소 권한: 판매자
router.post('/:id', permission('seller'), addProduct) // 상품 추가
